...
var minColorValue = -14.522;      // Values below this appear as white (underflow)
var maxColorValue = 15.084;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = ((sample.B05 - sample.B04) - 0.2 * (sample.B05 - sample.B03) * (sample.B05 / sample.B04)) / ((1.0 + 0.16) * (sample.B08 - sample.B04) / (sample.B08 + sample.B04 + 0.16));
    let zero = 0.0;

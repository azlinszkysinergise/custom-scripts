...
var maxColorValue = 0.882;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 1.2 * (1.2 * (sample.B08 - sample.B03) - 2.5 * (sample.B04 - sample.B03));
    let zero = 0.0;

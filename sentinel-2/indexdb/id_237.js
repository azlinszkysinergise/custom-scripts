...
var minColorValue = -0.571;      // Values below this appear as white (underflow)
var maxColorValue = 0.574;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 2.4 * (sample.B08 - sample.B04) / (sample.B08 + sample.B04 + 1.0);
    let zero = 0.0;

...
var minColorValue = -1.0;      // Values below this appear as white (underflow)
var maxColorValue = -1.0;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let MIDIR = 0.101;

    let index = Math.log(1.0 - (sample.B08 - MIDIR)) / (-Math.log(1.0 - (sample.B08 - MIDIR)));

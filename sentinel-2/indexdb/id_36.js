...
var minColorValue = 0.006;      // Values below this appear as white (underflow)
var maxColorValue = 0.034;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (1.0 / (30.5)) * (sample.B04 + sample.B03 + sample.B02);

...
var minColorValue = 2.523;      // Values below this appear as white (underflow)
var maxColorValue = 70.698;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 1.0 / sample.B05;

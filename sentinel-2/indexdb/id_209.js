...
var minColorValue = -0.971;      // Values below this appear as white (underflow)
var maxColorValue = 0.575;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 1.22 * (sample.B08 - 1.22 * sample.B04 - 0.03) / (1.22 * sample.B08 + sample.B04 - 1.22 * 0.03 + 0.08 * (1.0 + Math.pow(1.22, 2.0)));
    let zero = 0.0;

...
var minColorValue = -281.46;      // Values below this appear as white (underflow)
var maxColorValue = 1726.494;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 705.0 + 35.0 * ((((sample.B04 + sample.B07) / 2.0) - sample.B05) / (sample.B06 - sample.B05));
    let zero = 0.0;

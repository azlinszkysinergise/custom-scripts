...
var minColorValue = 0.032;      // Values below this appear as white (underflow)
var maxColorValue = 3.228;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B08 / (sample.B04 + sample.B12);

...
var minColorValue = -0.957;      // Values below this appear as white (underflow)
var maxColorValue = 0.177;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - (sample.B03 + sample.B04 + sample.B02)) / (sample.B08 + (sample.B03 + sample.B04 + sample.B02));
    let zero = 0.0;

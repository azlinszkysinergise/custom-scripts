...
var minColorValue = -0.734;      // Values below this appear as white (underflow)
var maxColorValue = 10.383;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let MIRmin = 0.259;
    let MIRmax = 0.640;

    let index = sample.B08 / sample.B04 * MIRmax - sample.B12 / MIRmax - MIRmin;
    let zero = 0.0;

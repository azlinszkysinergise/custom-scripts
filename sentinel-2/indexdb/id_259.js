...
function setup() {
    return {
        input: ["B01", "B04", "B08", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = -16.803;      // Values below this appear as white (underflow)
var maxColorValue = 16.613;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - sample.B04) / (sample.B08 + sample.B04 - 2.0 * sample.B01);
    let zero = 0.0;

...
var minColorValue = 0.044;      // Values below this appear as white (underflow)
var maxColorValue = 12.54;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let r500 = 0.535;
    let r800 = 0.712;

    let index = (sample.B08 / sample.B02) / (r800 / r500);

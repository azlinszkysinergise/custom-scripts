...
var minColorValue = 0.253;      // Values below this appear as white (underflow)
var maxColorValue = 208.643;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B04 / (sample.B03 * sample.B05);

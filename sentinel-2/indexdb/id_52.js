...
var minColorValue = 0.031;      // Values below this appear as white (underflow)
var maxColorValue = 0.765;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B04 / (sample.B08 + sample.B04 + sample.B03);

...
var minColorValue = -0.353;      // Values below this appear as white (underflow)
var maxColorValue = 1.498;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 1.2 * (sample.B05 - sample.B03) - 1.5 * (sample.B04 - sample.B03) * Math.sqrt(sample.B05 / sample.B04);
    let zero = 0.0;

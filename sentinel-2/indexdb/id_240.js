...
var minColorValue = -0.53;      // Values below this appear as white (underflow)
var maxColorValue = 0.532;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - sample.B04) / Math.pow((sample.B08 + sample.B04), 0.5);
    let zero = 0.0;

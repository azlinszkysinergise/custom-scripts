...
var minColorValue = 0.016;      // Values below this appear as white (underflow)
var maxColorValue = 220.152;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B08 * sample.B04 / Math.pow(sample.B03, 2.0);

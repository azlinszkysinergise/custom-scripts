...
var minColorValue = 0.049;      // Values below this appear as white (underflow)
var maxColorValue = 42.291;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let SWIRI = 0.887;

    let index = SWIRI / sample.B08;

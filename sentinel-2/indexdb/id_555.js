...
var minColorValue = -0.56;      // Values below this appear as white (underflow)
var maxColorValue = 0.558;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (1.0 + 0.5) * (sample.B08 - sample.B04) / (sample.B08 + sample.B04 + 0.5);
    let zero = 0.0;

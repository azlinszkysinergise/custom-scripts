...
var minColorValue = -0.563;      // Values below this appear as white (underflow)
var maxColorValue = 0.563;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let L = 0.482;

    let index = (sample.B08 - sample.B03) / (sample.B08 + sample.B03 + L) * (1.0 + L);
    let zero = 0.0;

...
var minColorValue = -64.354;      // Values below this appear as white (underflow)
var maxColorValue = 64.803;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 1.0 / sample.B03 - 1.0 / sample.B05;
    let zero = 0.0;

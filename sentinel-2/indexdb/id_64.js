...
var minColorValue = -1.58;      // Values below this appear as white (underflow)
var maxColorValue = 0.101;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let a = 0.149;
    let ar = 0.374;
    let b = 0.735;

    let index = (1.0 / Math.sqrt(Math.pow(a, 2.0) + 1.0)) * (sample.B08 - ar - b);
    let zero = 0.0;

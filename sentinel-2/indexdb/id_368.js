...
var minColorValue = 0.013900000000000001;      // Values below this appear as white (underflow)
var maxColorValue = 0.7861;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = Math.pow(sample.B03, (-1.0));

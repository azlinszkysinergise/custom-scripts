...
var minColorValue = -2.828;      // Values below this appear as white (underflow)
var maxColorValue = 2.837;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = Math.log(sample.B08 / sample.B04);
    let zero = 0.0;

...
var maxColorValue = 0.527;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - (sample.B03 + sample.B04)) / (sample.B08 + (sample.B03 + sample.B04));
    let zero = 0.0;

...
var minColorValue = -0.443;      // Values below this appear as white (underflow)
var maxColorValue = 0.579;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (2.0 * sample.B08 + 1.0 - Math.sqrt(Math.pow((2.0 * sample.B08 + 1.0), 2.0) - 8.0 * (sample.B08 - sample.B04))) / 2.0;
    let zero = 0.0;

...
var minColorValue = -0.512;      // Values below this appear as white (underflow)
var maxColorValue = 0.512;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let L = 0.725;

    let index = (sample.B08 - sample.B04) / (sample.B08 + sample.B04 + L) * (1.0 + L);
    let zero = 0.0;

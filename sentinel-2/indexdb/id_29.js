...
var minColorValue = -0.657;      // Values below this appear as white (underflow)
var maxColorValue = 0.653;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let Y = 0.120;

    let index = (sample.B08 - sample.B03) / (sample.B08 + sample.B03 + Y);
    let zero = 0.0;

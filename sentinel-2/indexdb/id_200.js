...
var minColorValue = 0.241;      // Values below this appear as white (underflow)
var maxColorValue = 4.135;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = Math.sqrt(sample.B08 / sample.B04);

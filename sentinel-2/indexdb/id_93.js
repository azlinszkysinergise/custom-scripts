...
var minColorValue = -0.279;      // Values below this appear as white (underflow)
var maxColorValue = 0.217;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 0.1509 * sample.B02 + 0.1973 * sample.B03 + 0.3279 * sample.B04 + 0.3406 * sample.B08 - 0.7112 * sample.B11 - 0.4572 * sample.B12;
    let zero = 0.0;

...
function setup() {
    return {
        input: ["B04", "B05", "B07", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = -33.128;      // Values below this appear as white (underflow)
var maxColorValue = 33.474;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B07 - sample.B05) / (sample.B07 - sample.B04);
    let zero = 0.0;

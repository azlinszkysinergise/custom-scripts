...
var minColorValue = -0.918;      // Values below this appear as white (underflow)
var maxColorValue = 3.768;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = ((sample.B08 / sample.B04) - 1.0) / Math.sqrt((sample.B08 / sample.B04) + 1.0);
    let zero = 0.0;

...
var minColorValue = -0.116;      // Values below this appear as white (underflow)
var maxColorValue = 0.371;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 0.404 * sample.B03 - 0.039 * sample.B04 - 0.505 * sample.B06 + 0.762 * sample.B09;
    let zero = 0.0;

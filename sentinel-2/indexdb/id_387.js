...
var minColorValue = -8.09;      // Values below this appear as white (underflow)
var maxColorValue = 8.065;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 2.5 * (sample.B08 - sample.B04) / (1.0 + sample.B08 + 6.0 * sample.B04 - 7.5 * sample.B02);
    let zero = 0.0;

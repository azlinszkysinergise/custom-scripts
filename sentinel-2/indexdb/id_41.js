...
var minColorValue = -0.103;      // Values below this appear as white (underflow)
var maxColorValue = 4.677;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = ((sample.B05 - sample.B04) - 0.2 * (sample.B05 - sample.B03)) * (sample.B05 / sample.B04);
    let zero = 0.0;

...
var minColorValue = -0.266;      // Values below this appear as white (underflow)
var maxColorValue = 0.266;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - sample.B04) / Math.sqrt(sample.B08 + sample.B04) * 0.5;
    let zero = 0.0;

...
var minColorValue = -0.492;      // Values below this appear as white (underflow)
var maxColorValue = 0.826;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = ((sample.B08 + 0.1) - (sample.B12 + 0.02)) / ((sample.B08 + 0.1) + (sample.B12 + 0.02));
    let zero = 0.0;

...
var minColorValue = 0.134;      // Values below this appear as white (underflow)
var maxColorValue = 1.182;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = Math.sqrt((((sample.B04 - sample.B03) / (sample.B04 + sample.B03))) + 0.5);

...
var minColorValue = 0.069;      // Values below this appear as white (underflow)
var maxColorValue = 20.16;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let r700 = 0.989;
    let r680 = 0.848;

    let index = (sample.B04 / sample.B05) / (r680 / r700);

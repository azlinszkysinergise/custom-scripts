...
var minColorValue = 0.057;      // Values below this appear as white (underflow)
var maxColorValue = 17.289;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B09 / sample.B11;

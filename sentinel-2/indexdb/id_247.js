...
var minColorValue = -211.158;      // Values below this appear as white (underflow)
var maxColorValue = 200.042;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let a = 0.419;
    let b = 0.787;

    let index = (a * sample.B08 - a * sample.B04 - b) / (sample.B04 + a * sample.B08 - a * b);
    let zero = 0.0;

...
function setup() {
    return {
        input: ["B04", "B05", "B06", "B07", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = -425.467;      // Values below this appear as white (underflow)
var maxColorValue = 1867.294;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 702.0 + 40.0 * ((((sample.B04 + sample.B07) / 2.0) - sample.B05) / (sample.B06 - sample.B05));
    let zero = 0.0;

...
var minColorValue = -32.988;      // Values below this appear as white (underflow)
var maxColorValue = 32.84;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = ((sample.B08 - sample.B05) / (sample.B08 + sample.B05)) / ((sample.B08 - sample.B04) / (sample.B08 + sample.B04));
    let zero = 0.0;

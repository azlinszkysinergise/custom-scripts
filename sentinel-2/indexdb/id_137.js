...
var minColorValue = -425.302;      // Values below this appear as white (underflow)
var maxColorValue = 1865.673;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 700.0 + 40.0 * ((((sample.B04 + sample.B07) / 2.0) - sample.B05) / (sample.B06 - sample.B05));
    let zero = 0.0;

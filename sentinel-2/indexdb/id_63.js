...
var minColorValue = -0.705;      // Values below this appear as white (underflow)
var maxColorValue = 0.704;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (1.0 + 0.16) * (sample.B08 - sample.B04) / (sample.B08 + sample.B04 + 0.16);
    let zero = 0.0;

...
var minColorValue = -0.232;      // Values below this appear as white (underflow)
var maxColorValue = 0.255;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 0.723 * sample.B03 - 0.597 * sample.B04 + 0.206 * sample.B06 - 0.278 * sample.B09;
    let zero = 0.0;

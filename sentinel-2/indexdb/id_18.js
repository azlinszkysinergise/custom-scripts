...
function setup() {
    return {
        input: ["B03", "B04", "B08", "B12", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = 0.359;      // Values below this appear as white (underflow)
var maxColorValue = 23.837;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B12 / sample.B08 + sample.B03 / sample.B04;

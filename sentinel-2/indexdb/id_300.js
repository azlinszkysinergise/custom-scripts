...
var minColorValue = 0.097;      // Values below this appear as white (underflow)
var maxColorValue = 28.672;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let r680 = 0.523;
    let r800 = 0.866;

    let index = (sample.B04 / sample.B08) / (r680 / r800);

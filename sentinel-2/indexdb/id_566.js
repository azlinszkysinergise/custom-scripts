...
function setup() {
    return {
        input: ["B03", "B04", "B06", "B09", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = -0.315;      // Values below this appear as white (underflow)
var maxColorValue = 0.137;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = -0.899 * sample.B03 + 0.428 * sample.B04 + 0.076 * sample.B06 - 0.041 * sample.B09;
    let zero = 0.0;

...
var minColorValue = -32.166;      // Values below this appear as white (underflow)
var maxColorValue = 33.194;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - sample.B01) / (sample.B08 - sample.B04);
    let zero = 0.0;

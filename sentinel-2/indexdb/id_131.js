...
var minColorValue = -0.941;      // Values below this appear as white (underflow)
var maxColorValue = 16.113;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B08 / sample.B05 - 1.0;
    let zero = 0.0;

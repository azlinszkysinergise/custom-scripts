...
var minColorValue = -66.488;      // Values below this appear as white (underflow)
var maxColorValue = 65.829;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (2.0 * sample.B04 - sample.B03 - sample.B02) / (sample.B03 - sample.B02);
    let zero = 0.0;

...
function setup() {
    return {
        input: ["B03", "B05", "B08", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = -14.739;      // Values below this appear as white (underflow)
var maxColorValue = 14.963;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (Math.pow(sample.B03, (-1.0)) - Math.pow(sample.B05, (-1.0))) * sample.B08;
    let zero = 0.0;

...
var minColorValue = 0.058;      // Values below this appear as white (underflow)
var maxColorValue = 16.866;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let r700 = 0.715;
    let r675 = 0.722;

    let index = (sample.B04 / sample.B05) / (r675 / r700);

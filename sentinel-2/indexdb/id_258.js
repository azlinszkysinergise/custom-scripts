...
function setup() {
    return {
        input: ["B02", "B05", "B08", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = -14.847;      // Values below this appear as white (underflow)
var maxColorValue = 14.965;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (Math.pow(sample.B02, (-1.0)) - Math.pow(sample.B05, (-1.0))) * sample.B08;
    let zero = 0.0;

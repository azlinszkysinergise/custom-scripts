...
var minColorValue = -0.222;      // Values below this appear as white (underflow)
var maxColorValue = 0.284;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = -0.386 * sample.B03 - 0.53 * sample.B04 + 0.535 * sample.B06 + 0.532 * sample.B09;
    let zero = 0.0;

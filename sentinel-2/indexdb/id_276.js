...
var minColorValue = -109.359;      // Values below this appear as white (underflow)
var maxColorValue = -2.985;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let a = 0.393;
    let b = 0.809;

    let index = (sample.B08 - b) / (a * sample.B04);

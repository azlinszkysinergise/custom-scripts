...
var minColorValue = -0.288;      // Values below this appear as white (underflow)
var maxColorValue = 0.865;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 2.4 * sample.B09 - sample.B04;
    let zero = 0.0;

...
var minColorValue = -0.337;      // Values below this appear as white (underflow)
var maxColorValue = 0.155;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = -0.2848 * sample.B02 - 0.2435 * sample.B03 - 0.5436 * sample.B04 + 0.7243 * sample.B08 + 0.084 * sample.B11 - 0.18 * sample.B12;
    let zero = 0.0;

...
var minColorValue = -0.863;      // Values below this appear as white (underflow)
var maxColorValue = 0.291;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B09 - 2.4 * sample.B04;
    let zero = 0.0;

...
var minColorValue = -1.066;      // Values below this appear as white (underflow)
var maxColorValue = 1.073;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 3.0 * ((sample.B05 - sample.B04) - 0.2 * (sample.B05 - sample.B03) * (sample.B05 / sample.B04));
    let zero = 0.0;

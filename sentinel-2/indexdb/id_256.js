...
var minColorValue = 0.014;      // Values below this appear as white (underflow)
var maxColorValue = 0.871;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let a = 0.331;
    let b = 0.329;

    let index = a * sample.B04 / Math.pow((sample.B03 * sample.B05), b);

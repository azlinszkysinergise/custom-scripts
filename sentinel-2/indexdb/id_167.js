...
var minColorValue = -32.943;      // Values below this appear as white (underflow)
var maxColorValue = 32.889;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - sample.B01) / (sample.B04 - sample.B01);
    let zero = 0.0;

...
var minColorValue = 0.191;      // Values below this appear as white (underflow)
var maxColorValue = 56.218;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let r470 = 0.503;
    let r800 = 0.153;

    let index = (sample.B08 / sample.B02) / (r800 / r470);

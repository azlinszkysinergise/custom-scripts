...
var minColorValue = 0.14;      // Values below this appear as white (underflow)
var maxColorValue = 0.637;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 0.406 * sample.B03 + 0.6 * sample.B04 + 0.645 * sample.B06 + 0.243 * sample.B09;

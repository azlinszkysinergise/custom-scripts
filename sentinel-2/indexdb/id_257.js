...
var minColorValue = -14.929;      // Values below this appear as white (underflow)
var maxColorValue = 14.894;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (Math.pow(sample.B02, (-1.0)) - Math.pow(sample.B03, (-1.0))) * sample.B08;
    let zero = 0.0;

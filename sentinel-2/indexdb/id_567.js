...
var minColorValue = -0.107;      // Values below this appear as white (underflow)
var maxColorValue = 0.342;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = -0.016 * sample.B03 + 0.131 * sample.B04 - 0.425 * sample.B06 + 0.882 * sample.B09;
    let zero = 0.0;

...
var minColorValue = -31.864;      // Values below this appear as white (underflow)
var maxColorValue = 33.576;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - sample.B02) / (sample.B08 - sample.B04);
    let zero = 0.0;

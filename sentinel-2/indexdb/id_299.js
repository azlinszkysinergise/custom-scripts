...
var minColorValue = 0.144;      // Values below this appear as white (underflow)
var maxColorValue = 41.524;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let r670 = 0.382;
    let r800 = 0.935;

    let index = (sample.B04 / sample.B08) / (r670 / r800);

...
function setup() {
    return {
        input: ["B02", "B03", "B04", "B08", "B12", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = 0.22;      // Values below this appear as white (underflow)
var maxColorValue = 0.727;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 0.3037 * sample.B02 + 0.2793 * sample.B03 + 0.4743 * sample.B04 + 0.5585 * sample.B08 + 0.5082 * B10 + 0.1863 * sample.B12;

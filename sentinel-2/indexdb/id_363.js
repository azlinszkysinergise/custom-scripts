...
var minColorValue = -33.268;      // Values below this appear as white (underflow)
var maxColorValue = 33.294;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - (sample.B03 - (sample.B02 - sample.B04))) / (sample.B08 - (sample.B03 + (sample.B02 - sample.B04)));
    let zero = 0.0;

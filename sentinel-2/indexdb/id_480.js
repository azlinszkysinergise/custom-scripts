...
var minColorValue = -723.725;      // Values below this appear as white (underflow)
var maxColorValue = 720.008;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (1.0 / sample.B03 - 1.0 / sample.B05) / sample.B08;
    let zero = 0.0;

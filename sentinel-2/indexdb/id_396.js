...
var minColorValue = -1.221;      // Values below this appear as white (underflow)
var maxColorValue = 0.862;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = -0.18 + 1.17 * ((sample.B08 - sample.B04) / (sample.B08 + sample.B04));
    let zero = 0.0;

...
var minColorValue = -0.79;      // Values below this appear as white (underflow)
var maxColorValue = 0.327;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B08 - 0.5 * sample.B12 / (sample.B08 + 0.56 * sample.B12);
    let zero = 0.0;

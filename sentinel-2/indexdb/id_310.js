...
var minColorValue = 0.001;      // Values below this appear as white (underflow)
var maxColorValue = 0.027;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let a = 0.064;
    let b = 0.918;

    let index = sample.B08 / (sample.B04 + b / a);

...
var maxColorValue = 0.528;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B08 - (sample.B04 + sample.B02)) / (sample.B08 + (sample.B04 + sample.B02));
    let zero = 0.0;

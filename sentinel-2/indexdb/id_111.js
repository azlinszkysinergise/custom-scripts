...
var minColorValue = -0.998;      // Values below this appear as white (underflow)
var maxColorValue = 0.683;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (Math.pow(sample.B08, 2.0) - sample.B04) / (Math.pow(sample.B08, 2.0) + sample.B04);
    let zero = 0.0;

...
var minColorValue = -15.455;      // Values below this appear as white (underflow)
var maxColorValue = 15.386;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B03 - sample.B04) / (sample.B03 + sample.B04 - sample.B02);
    let zero = 0.0;

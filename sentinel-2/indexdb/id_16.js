...
var minColorValue = -8.155;      // Values below this appear as white (underflow)
var maxColorValue = 7.894;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 2.5 * (sample.B08 - sample.B04) / ((sample.B08 + 6.0 * sample.B04 - 7.5 * sample.B02) + 1.0);
    let zero = 0.0;

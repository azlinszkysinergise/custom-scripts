...
var minColorValue = -64.099;      // Values below this appear as white (underflow)
var maxColorValue = 64.37;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = Math.pow(sample.B02, (-1.0)) - Math.pow(sample.B05, (-1.0));
    let zero = 0.0;

...
var maxColorValue = 0.264;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (0.1 * sample.B08 - sample.B04) / (0.1 * sample.B08 + sample.B04);
    let zero = 0.0;

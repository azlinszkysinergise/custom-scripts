...
var minColorValue = -0.988;      // Values below this appear as white (underflow)
var maxColorValue = 0.258;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (0.1 * sample.B08 - sample.B02) / (0.1 * sample.B08 + sample.B02);
    let zero = 0.0;

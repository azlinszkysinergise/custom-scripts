...
var minColorValue = -0.88;      // Values below this appear as white (underflow)
var maxColorValue = 0.735;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (2.0 * sample.B03 - sample.B04 - sample.B02) / (2.0 * sample.B03 + sample.B04 + sample.B02);
    let zero = 0.0;

...
var minColorValue = -0.888;      // Values below this appear as white (underflow)
var maxColorValue = 0.887;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = (sample.B05 - sample.B04) / (sample.B05 + sample.B04);
    let zero = 0.0;

...
var minColorValue = 0.137;      // Values below this appear as white (underflow)
var maxColorValue = 0.63;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = 0.332 * sample.B03 + 0.603 * sample.B04 + 0.675 * sample.B06 + 0.262 * sample.B09;

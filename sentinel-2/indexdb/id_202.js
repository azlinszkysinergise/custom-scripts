...
var minColorValue = 0.136;      // Values below this appear as white (underflow)
...
function evaluatePixel(sample) {    let index = Math.sqrt((sample.B08 - sample.B04) / (sample.B08 + sample.B04) + 0.5);

...
var minColorValue = -46.647;      // Values below this appear as white (underflow)
var maxColorValue = 49.256;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let y = 0.735;
    let Rr = 0.740;
    let L = 0.487;
    let RB = 0.560;

    let index = (1.0 + L) * (sample.B08 - (Rr - y * (RB - Rr))) / (sample.B08 + -(Rr - y * (RB - Rr)) + L);
    let zero = 0.0;

...
function setup() {
    return {
        input: ["B03", "B05", "B8A", "SCL", "dataMask"],
        output: [
            { id: "default", bands: 4 },
...
var minColorValue = 0.256;      // Values below this appear as white (underflow)
var maxColorValue = 207.696;     // Values above this appear as black (overflow)
...
function evaluatePixel(sample) {    let index = sample.B8A / (sample.B03 * sample.B05);
